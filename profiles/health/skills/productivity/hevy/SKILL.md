...
- Server `hevy` = `node …/node_modules/hevy-mcp/dist/cli.mjs`, all 22 tools enabled. Health profile, 2026-09-19.
- Secret: BWS `HEVY_API_KEY` → `${env:HEVY_API_KEY}` (Bitwarden Secrets Manager enabled on the health profile, EU vault)
